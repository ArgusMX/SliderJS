class Carousel {
  constructor(p) {
    const settings = {...{containerID: '#carousel', slideID: '.slide', interval: 2000, isPlaying: false},...p};
  ...
  _initControls() {
    ...
    this.isPlaying ? this.pauseBtn.innerHTML = this.FA_PAUSE : this.pauseBtn.innerHTML = this.FA_PLAY ;
  }
